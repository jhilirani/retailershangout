...
$DirSeparator='/';
$ServerDataArr=explode($DirSeparator,BASEPATH);
if(count($ServerDataArr)<2){
	$ServerDataArr=explode('\\',$ServerDataArr[0]);
	$DirSeparator='\\';
}
array_pop($ServerDataArr);
array_pop($ServerDataArr);

define('MAIN_SERVER_PATH', implode($DirSeparator,$ServerDataArr));
