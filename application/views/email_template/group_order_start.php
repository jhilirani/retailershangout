            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top">
					...
					New Hangout order running by <strong><?php echo $group_order_start['TEMPLATE_GROUP_ORDER_START_TITLE'];?></strong>
                    </font> <br /><br /><br />
                   <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
				   Hi, <br /><br /> You have requested to buy Hangout order product. <br /><br />
				   ...
				   <a href='<?php echo BASE_URL;?>shopping/group-order-decline/<?php echo base64_encode($group_order_start['TEMPLATE_GROUP_ORDER_START_ORDERID']*226201);?>'>Decline the Hangout Order</a><br /><br />
				   <a href='<?php echo BASE_URL;?>shopping/group-order-accept-process/<?php echo base64_encode($group_order_start['TEMPLATE_GROUP_ORDER_START_ORDERID']*226201);?>'>Accept the Hangout Order</a><br /><br />
				   </font>
