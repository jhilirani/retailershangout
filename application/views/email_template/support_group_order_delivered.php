                          ...
                          <td valign="top" align="center" class="col" width="250" style="background-color:#ffffff;"><table border="0" cellspacing="0" cellpadding="0" width="100%">
                              <tbody>
                                <tr>
								  ...
								  <img border="0" src="<?php echo $SiteProductImageURL. $orderInfoDataArr['pimage']->image;?>" 								  <img border="0" src="<?php echo $SiteProductImageURL. $orderInfoDataArr['pimage']->image;?>" alt="<?php echo $orderInfoDataArr['pdetail']->title;?>" title="<?php echo $orderInfoDataArr['pdetail']->title;?>" style="display: block;" height="100" width="100">
								  </a> 
								  </td>
