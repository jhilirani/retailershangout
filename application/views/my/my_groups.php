                    	...
                    	<div class="active row">
                        	<div class="col-md-12 col-sm-12">
                             <div class="gen_infmtn">
                            	<h6>My Hangouts <span class="pull-right"><input type="button" data-toggle="modal" data-target="#myModalLogin" name="" value="Creat New Hangout" /></span></h6>
                                </div>
                                    <div class="js-my-groups">    
                                        <?php if(!empty($myGroups)):
                                        foreach($myGroups as $gkey => $group):?>        
                                        <div class="col-md-3 col-sm-3 grp_dashboard js-group-popover" title="<i class='fa fa-group'></i> Hangout : <?=$group->groupTitle?>"  data-container="body" data-toggle="popover" data-placement="top" data-color="<?=$group->groupColor?>" id="group-id-<?=$group->groupId?>" data-content='<div class="row">
                                             <div class="col-md-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Create New Hangout</h4>
      </div>
      ...
      <div class="modal-body">  
              ...
              <div class="form-group">
                  <label for="groupTitle" class="col-sm-3 control-label">Hangout Name</label>
                  <div class="col-sm-7">
