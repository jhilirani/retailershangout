...
class Ajax extends MY_Controller{
    ...
    public function check_login(){
        /*if(strtoupper(trim($this->session->userdata('FE_SESSION_USER_LOCATION_VAR')))!='IN'){
            echo json_encode(array('result'=>'bad','msg'=>'Please check your "Username" and "Password" and try again......'.strtoupper(trim($this->session->userdata('FE_SESSION_USER_LOCATION_VAR')))));die;     
        }*/
    ...
    public function check_registration(){
        common_maintain_action_log('comming for seller registration','at ajax controller by check_registration FUN');
        /*if(strtoupper(trim($this->session->userdata('FE_SESSION_USER_LOCATION_VAR')))!='IN'){
            echo json_encode(array('result'=>'bad','msg'=>'Please check your "Username" and "Password" and try again.'));die;     
        }*/
        // sleep for 10 seconds
