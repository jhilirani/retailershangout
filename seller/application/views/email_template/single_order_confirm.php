            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi <?php echo $orderInfo['shipping']->firstName.' '.$orderInfo['shipping']->lastName;?>,</em></strong></font><br />
                    <br />
                    <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">Thanks for shopping with Dailyplaza Online Pvt Ltd. <br />
                    <br />
					<?php echo $SellerName;?> has confirmed that the following items for your order <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">RH-OD-<?php echo $single_order_confirm['TEMPLATE_ORDER_CONFIRM_ORDER_ID'];?></span></a> will be serviced by them. 
                    We will send you another email once the items in your order have been shipped. Meanwhile, you can check the status of your order on Retailershangout.com</font> <br /></td>
                  <td width="10%">&nbsp;</td>
                </tr>
                <tr>
                      ...
                      <tbody>
                        <tr>
                          <td align="left" valign="top" style="background-color:#FFFFFF;display:block;clear:both;padding:20px 20px 0 20px;" bgcolor=""><table border="0" cellspacing="0" cellpadding="0" width="100%" style="">
                              <tbody>
                                <tr>
                                  <td colspan="4" width="100%" align="middle" valign="top"><p style="padding:0;color:#565656;line-height:22px;font-size:13px;">Please find below, the summary of your order <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">RH-OD-<?php echo $single_order_confirm['TEMPLATE_ORDER_CONFIRM_ORDER_ID'];?></span></a> </p>
                                    <br>
                                  </td>
                                </tr>
                                <?php /*<tr> 
                          ...
                          <td valign="top" align="center" class="col" width="350" style="background-color:#ffffff;"><table border="0" cellspacing="0" cellpadding="0" width="100%">
                              <tbody>
                                <tr>
								  ...
								  <img border="0" src="<?php echo $SiteProductImageURL. $orderInfo['pimage']->image;?>" alt="<?php echo $orderInfo['pdetail']->title;?>" title="<?php echo $orderInfo['pdetail']->title;?>" style="display: block;" height="100" width="100">
								  </a> 
								  </td>
