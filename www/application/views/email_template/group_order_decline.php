      ...
      <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="200"><a href= "<?php echo $MainSiteBaseURL;?>" target="_blank"><img src="<?php echo $MainSiteImagesURL;?>logo.png" title="Retailershangout Inc Ltd" width="200px" height="100" border="0" alt=""/></a></td>
                  <td width="1"></td>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="80%" align="left" valign="top">
					...
					Buyer Club Re-order [RH-OD<?php echo $group_order_decline['TEMPLATE_GROUP_ORDER_DECLINE_ORDER_ID'];?>] cancel by <strong><?php echo $group_order_decline['TEMPLATE_GROUP_ORDER_DECLINE_ADMIN_NAME'];?></strong>
                    </font> <br /><br /><br />
