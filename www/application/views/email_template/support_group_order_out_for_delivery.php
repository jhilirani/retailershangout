                ...
                <tr>
                  ...
                  <td width="80%" align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#010101; font-size:14px"><strong><em>Hi <?php echo $supportFullName;?>,</em></strong></font><br />
                    ...
                    <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">
						This is a pre-alert that Hangout order <a style="text-decoration:underline;" target="_blank" href="#"><span style="color:#565656;font-size:13px;">RH-OD-<?php echo $orderDetails[0]->orderId;?></span></a> is ready to <strong>Out For Delivery</strong> for <?php echo $buyerFullName;?>
